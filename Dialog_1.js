let infoPazient=["Иванов","Иван","Иванович",15,"мая",1974,"м"];
        ...
        */
        var person={
            ...
            "SNILS 4":["Романов","Пётр","Владиславович", 4,"августа",1993,"ж","медотвод"],
            "SNILS 5":["Иванов","Сергей","Васильевич", 6,"июля",1993,"ж","назначено"],
            "SNILS 6":["Петрова","Надежда","Валериевна", 13,"сентября",1993,"ж","медотвод"],
            "SNILS 7":["Осипов","Артур","Евгениевич", 30,"апреля",1993,"ж","медотвод"],
            "SNILS 8":["Соколова","Вера","Петровна", 23,"февраля",1993,"ж","исполнено"],
            "SNILS 9":["Воронцов","Виктор","Петрович", 5,"октября",1993,"ж","исполнено"],
            "SNILS 10":["Васильев","Натан","Янович", 3,"января",1993,"ж","назначено"],
    };
    console.log(person);
    SNILS4=" SNILS 4"
   /* let lastname;
